...
export default function AddressBookError({
  ...
  useEffect(() => {
    console.error("[contacts] error boundary:", error.message, error.digest);
  }, [error]);
    ...
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      <div className="max-w-md">
        <h1 className="font-serif text-3xl text-primary-green sm:text-4xl">
          Address Book could not load
        </h1>
        <p className="mt-4 text-sm text-gray-600 sm:text-base">
          Something went wrong loading the address book page. You can try
